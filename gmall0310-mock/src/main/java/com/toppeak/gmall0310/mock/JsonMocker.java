...
import com.toppeak.gmall0310.util.RanOpt;
import com.toppeak.gmall0310.util.RandomDate;
import com.toppeak.gmall0310.util.RandomNum;
import com.toppeak.gmall0310.util.RandomOptionGroup;
...
public class JsonMocker {
    ...
    RanOpt[] areaOpts = {new RanOpt("beijing", 10),
            ...
            new RanOpt("shanxi", 5), new RanOpt("hubei", 5), new RanOpt("sichuan", 5)
    };
